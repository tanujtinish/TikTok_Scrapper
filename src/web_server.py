...
def scrape_tiktok_posts():
    try:
        app.logger.info("enter api scrape_tiktok_posts")
        ...
        app.logger.info("exit api scrape_tiktok_posts: " + str(len(posts)))
        return jsonify({"success": True, "posts": posts}), 200
    except Exception as e:
        app.logger.info("error api scrape_tiktok_posts: "+str(e))
...
async def fetch_comments_for_scrapped_posts():
    try:
        app.logger.info("enter api fetch_comments_for_scrapped_posts")
        ...
        app.logger.info("exit api fetch_comments_for_scrapped_posts: " + str(len(posts)))
        return jsonify({"success": True, "posts_with_comments": posts}), 200
    except Exception as e:
        app.logger.info("error api fetch_comments_for_scrapped_posts: "+str(e))
        return jsonify({"success": False, "error": str(e)}), 500
...
def filter_fasion_posts_with_relevance_scores():
    try:
        app.logger.info("enter api filter_fasion_posts_with_relevance_scores")
        ...
        app.logger.info("exit api filter_fasion_posts_with_relevance_scores: " + str(len(posts)))
        return jsonify({"success": True, "posts": posts}), 200
    except Exception as e:
        app.logger.info("error api filter_fasion_posts_with_relevance_scores: "+str(e))
        return jsonify({"success": False, "error": str(e)}), 500
...
def process_instagram_post_data():
    try:
        app.logger.info("enter api process_instagram_post_data")
        ...
        app.logger.info("exit api process_instagram_post_data: " + str(len(posts)))
        return jsonify({"success": True, "posts": posts}), 200
    except Exception as e:
        app.logger.info("error api process_instagram_post_data: "+str(e))
        return jsonify({"success": False, "error": str(e)}), 500
...
def get_scraped_fasion_posts():
    try:
        app.logger.info("enter api get_scraped_fasion_posts")
        ...
        app.logger.info("exit api get_scraped_fasion_posts: " + str(len(post_objs)))
        return jsonify({"success": True, "scraped_fasion_posts": post_objs}), 200
    except Exception as e:
        app.logger.info("error api get_scraped_fasion_posts: "+str(e))
        return jsonify({"success": False, "error": str(e)}), 500
...
def get_scraped_posts():
    try:
        ...
        app.logger.info("exit api scrape_tiktok_posts: " + str(len(post_objs)))
...
def get_scraped_posts_with_comments():
    try:
        app.logger.info("enter api get_scraped_posts_with_comments")
        ...
        app.logger.info("exit api get_scraped_posts_with_comments: " + str(len(post_objs)))
        return jsonify({"success": True, "scraped_posts_with_comments": post_objs}), 200
    except Exception as e:
        app.logger.info("error api get_scraped_posts_with_comments: "+str(e))
        return jsonify({"success": False, "error": str(e)}), 500
